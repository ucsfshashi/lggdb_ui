...
export default class AttentionEdit extends React.Component {
	...
	constructor(props) {
	    ...
	    this.state = {
    	   ...
    	   showLoading:false,
    	   isNewPatient:(this.props.data['Attention.timeLine'] == undefined)
		};
	...
	async saveInServer ()  {
	   ...
	   var path ='Patient/'+loginContext.mrn+'/Attention';
	   var data = this.state.data;
       ...
       if(rInfo && rInfo.data === true) {
    	   ...
    	   this.setState({errorMessage:'Failed to save Patient Attention changes'});
           this.setState({successMessage:null});
       }
