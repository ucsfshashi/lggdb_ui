...
export default class BloodDrawView extends React.Component {
	...
	getRows  = () => {
		return this.props.loginContext.schema.filter(el => el.topic === "BloodDraw");
	};
	...
	async extractData () {
        ...
        if(!patientInfo || !patientInfo[0]["BloodDraw.bdDate"]){
        	patientInfo =null;
        }
