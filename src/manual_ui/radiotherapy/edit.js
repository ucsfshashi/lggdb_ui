...
export default class RadiotherapyEdit extends React.Component {
	...
	async saveInServer ()  {
      ...
      if(rInfo && rInfo.data === true) {
   	    this.setState({successMessage:'Radiotherapy changes saved successfully'});
       	this.setState({errorMessage:null});
       	this.props.goBackToList(null);
       	
      } else {
   	   this.setState({errorMessage:'Failed to save Radiotherapy changes'});
          this.setState({successMessage:null});
      }
