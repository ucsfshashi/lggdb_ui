...
export default class TumorRadiotherapyView extends React.Component {
	...
	getRows  = (topicName) => {
		...
		var rows = this.props.loginContext.schema.filter(el => (el.topic === "Tumor Radiotherapy" 
	...
	async extractData () {
        ...
        var path ='Patient/'+loginContext.mrn+'/PatientTumor/'+this.props.parentInfo["PatientTumor.tumorLabel"]+'/TumorRadioTheraphy';
